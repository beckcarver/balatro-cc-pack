...
SMODS.Joker {
    ...
    calculate = function(self, card, context)
        ...
        if context.discard and not context.blueprint and not card.ability.extra.gained_this_discard then
            for _, discarded in ipairs(context.full_hand or {}) do
                if discarded:get_id() == 3 then -- rank 3
...
--             "{C:attention}3{} cards gain {C:mult}+#1#{} Mult",
--             "{C:inactive}(Currently: {C:mult}+#2#{}{C:inactive}){}"
--         }
--     },
